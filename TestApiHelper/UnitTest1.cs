...
namespace TestApiHelper
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMethod1()
        {
            ...
            var blah = aPIHelper.BuildDocumentJsonFromBase64AIResult(base64string, "abc123", "");

            List<SFPlatformEventData> data = new List<SFPlatformEventData>
            {
                new SFPlatformEventData { ObjectName = "tungstenconnect__Process_Name__c", ObjectValue = "ProcessOtherDocument" },
                new SFPlatformEventData { ObjectName = "tungstenconnect__Response_Message__c", ObjectValue = blah },
                new SFPlatformEventData { ObjectName = "tungstenconnect__Response_Timestamp__c", ObjectValue = DateTime.Now }
            };
            ...
            var response2 = aPIHelper.BuildEventDataJson("ProcessOtherDocument", "ProcessOtherDocument", blah);
